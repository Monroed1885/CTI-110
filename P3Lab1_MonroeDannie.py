...
#Get Vakue from user
total_change = int(input('Enter your amount:' ))
...
if num_quarters > 0:
    ...
    else:print('Quarters', num_quarters)
if num_dimes > 0:
    if num_dimes == 1:
        print('Dime:' , num_dimes)
    else: print('Dimes', num_dimes)
if num_nickels > 0:
    if num_nickels == 1:
        print('Nickel:', num_nickels)
    else: print('Nickels', num_nickels)
if num_pennies > 0:
    if num_pennies ==1:
        print('Penny:' , num_pennies)
    else: print('Pennies:', num_pennies)
